...
public class UnitConverterFrontend extends JFrame {
	...
	private JPanel createSek1Panel() {
		...
		fieldleft.addKeyListener(new FieldListener(fieldright, fieldleft,
				comboboxleft, comboboxright, this));
		fieldright.addKeyListener(new FieldListener(fieldleft, fieldright,
				comboboxright, comboboxleft, this));
		...
		ImageIcon arrow_icon = new ImageIcon(getClass().getResource(
				"/arrow_right.png"));
		arrow_icon = new ImageIcon(arrow_icon.getImage().getScaledInstance(40,
				40, java.awt.Image.SCALE_SMOOTH));
		arrow = new JLabel(arrow_icon);
		arrow.setLocation(257, H_SIZE / 3);
		arrow.setSize(40, 40);

		ImageIcon arrow_o_icon = new ImageIcon(getClass().getResource(
				"/arrow_left.png"));
		arrow_o_icon = new ImageIcon(arrow_o_icon.getImage().getScaledInstance(
		...
		comboboxleft.addActionListener(new BoxListener(fieldleft, fieldright,
				comboboxright, comboboxleft, this));
		comboboxright.addActionListener(new BoxListener(fieldright, fieldleft,
				comboboxleft, comboboxright, this));
	...
	private JPanel createSek2Panel() {
		...
		fieldleft_2.addKeyListener(new FieldListener(fieldright_2, fieldleft_2,
				comboboxleft_2, comboboxright_2, this));
		fieldright_2.addKeyListener(new FieldListener(fieldleft_2,
				fieldright_2, comboboxright_2, comboboxleft_2, this));
		...
		ImageIcon arrow2_icon = new ImageIcon(getClass().getResource(
				"/arrow_right.png"));
		arrow2_icon = new ImageIcon(arrow2_icon.getImage().getScaledInstance(
				40, 40, java.awt.Image.SCALE_SMOOTH));
		...
		ImageIcon arrow_o_icon2 = new ImageIcon(getClass().getResource(
				"/arrow_left.png"));
		arrow_o_icon2 = new ImageIcon(arrow_o_icon2.getImage()
		...
		comboboxleft_2.addActionListener(new BoxListener(fieldleft_2,
				fieldright_2, comboboxright_2, comboboxleft_2, this));
		comboboxright_2.addActionListener(new BoxListener(fieldright_2,
				fieldleft_2, comboboxleft_2, comboboxright_2, this));
		...
		if (lefte.getSelectedItem() != null && righte.getSelectedItem() != null)
			try {
				othertext.setText(Double.toString(Converter.convert(Double
						.parseDouble(thistext.getText()), lefte
						.getSelectedItem().toString(), righte.getSelectedItem()
						.toString())));
				label_err.setVisible(false);
			} catch (Exception e) {
				...
				for (String key : Converter.getConvertableUnits(righte
				...
				for (String key : Converter
						.getUnitsAppropriated(CONFIG.Units.ALL)) {
					lefte.addItem(key);
				}
